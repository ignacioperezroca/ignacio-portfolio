      ...
      <main>
        <section className="border-b border-ink/10 bg-white/48 py-14 dark:border-paper/10 dark:bg-paper/5 sm:py-20">
          <div className="section-shell">
            <Link
              href="/#work"
              className="focus-ring transition-premium inline-flex items-center gap-2 rounded-md text-sm font-semibold text-ink-muted hover:text-ink dark:text-paper/60 dark:hover:text-paper"
            >
        ...
        <section className="py-16 sm:py-24">
          <div className="section-shell grid gap-10 lg:grid-cols-[0.32fr_0.68fr] lg:items-start">
                  ...
                  <div className="mt-5 grid gap-3">
                    {storySections.map(([title]) => (
                      <a
                        ...
                        className="focus-ring transition-premium rounded-md border border-ink/10 px-3 py-2 text-sm font-semibold text-ink-muted hover:border-ink/25 hover:text-ink dark:border-paper/10 dark:text-paper/60 dark:hover:border-paper/25 dark:hover:text-paper"
                      >
                        {title}
                      </a>
                    ))}
            ...
            <div className="grid gap-5">
              {storySections.map(([title, key], index) => (
                <FadeIn key={title} delay={0.04 + index * 0.04}>
                  <section
                  ...
                  <div className="mt-6 grid gap-px overflow-hidden rounded-md border border-paper/10 bg-paper/10 md:grid-cols-3">
                    {study.story.metrics.map((metric, index) => (
                      <article key={metric.label} className="bg-ink p-5">
                        <FadeIn delay={0.04 + index * 0.04} variant="scaleIn">
